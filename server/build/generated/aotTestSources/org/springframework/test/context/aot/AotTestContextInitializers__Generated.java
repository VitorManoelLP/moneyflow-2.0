...
import com.moneyflow20.service.AccountManagerTest__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.moneyflow20.service.AccountManagerTest", () -> new AccountManagerTest__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.moneyflow20.service.AccountManagerTest", AccountManagerTest__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
